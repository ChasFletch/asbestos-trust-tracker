...
export const SOURCE_REGISTRY_OVERRIDES: Record<string, SourceRegistryOverride> = {
  ...
  "bondex-specialty-products-holding-corp-trust": { trustName: "Bondex (Specialty Products Holding Corp.) Trust", sourceUrl: "https://www.cpf-inc.com/trusts/bondex-trust", sourceClass: "administrator", retrievalNotes: "Replaces legacy host with TLS hostname mismatch; use the official CPF trust page." },
  ...
  "maremont-asbestos-pi-trust": { trustName: "Maremont Asbestos PI Trust", sourceUrl: "https://maremont.mfrclaims.com/", sourceClass: "administrator", retrievalNotes: "Replaces legacy host that terminates HTTPS; use official administrator portal." },
