...
|---|---|---|---|---|
| 2026-08-16 | Remaining-assets floor | $15,967,208,224 → **$15,987,271,944** (high $21,721,071,877 → $21,742,138,783) | Added Hercules Chemical **$4,018,899** and United Gilsonite UGL **$16,044,821** — FY2022, Verus-administered (b, research corpus followup_dim08). Dataset now 55 records / 42 with located figures | pending |
| 2026-08-16 | llms.txt / FAQ / fallbacks re-sync; per-claimant statistics section | payouts → **$30,020,097,653**; floor → **$15,987,271,944**; counts → **55 tracked / 42 with figures**; pct range → **0.7%–100%**; new "Per-Claimant Statistics: A Measured Void" content (RAND TR-872 p. xvii; Garlock 504 B.R. 71, 96; Ableman 30:19 Mealey's, verified) | Display-layer sync + sourcing audit 2026-08-16 | pending |
