...
**Report ID:** ATR-2026-Q3 · **Data as of:** July 27, 2026 · **Published:** July 28, 2026 · **Issue:** Inaugural (Q3 2026)
...
**How to cite:** Asbestos Trust Tracker, *State of the Asbestos Trust System — Q3 2026* (ATR-2026-Q3), data as of July 27, 2026, asbestostrusts.org.
...
The floor is not a census, and it is deliberately conservative. Roughly 19 of the ~60 active trusts publish no retrievable figure at all, and 28 of the 32 class-(b) figures carry FY2022 as-of dates (4 carry FY2021). Because trusts deplete over time, dated figures overstate some balances — but the uncounted ~19 trusts and deferred-obligation funding push the other way. The true current balance is higher than the floor; how much higher is the estimated range.
...
**Movement within the window.** The floor's composition improved materially this cycle: 23.3% of it now rests on filed documents rather than secondary carries — the nine class-(a) figures (NARCO, DII Industries, Manville, Western, Thorpe Insulation, Plant, J.T. Thorpe (CA), Maremont, API) entered the dataset from FY2025/FY2024 filings and Manville's Q1 2026 quarterly. Direction of travel, however, remains downward: two payment-percentage cuts and one reconsideration notice landed in the window (Section B), each a documented signal of continued net depletion at the trusts involved.
...
The dataset's changes log records the direction of travel unambiguously. Since January 2023, seven trusts have cut their payment percentages and none has raised one. The most recent documented increase anywhere in the system remains Manville's 4.3% → 5.1% raise of February 2021, which carried a retroactive true-up of ~$5.6M (a).

**Cut this window:**

- **Combustion Engineering** — cut in April 2026; current percentage 15.3% (b). The documented history (18.5% → 29.5% → 15.3% (b)) shows a trust that raised, then reversed hard as claim volumes persisted.
- **Babcock & Wilcox** — cut 4.7% → 4.3% by trust letter dated June 30, 2026 (a). The 4.3% rate applies "until further notice," pending TAC/FCR consent — the same consent architecture that has kept Pittsburgh Corning's November 2024 cut (24.5% → 19%, with a true-up rider if not adopted (a)) in procedural limbo for over a year and a half.

**Held this window (documented):** NARCO at 100% (a), DII Industries at 60% (a, maintained per filed 2024–25 annual reports), Thorpe Insulation at 58.6% (a), Western at 51.1% (a), Plant at 20% (a), Manville at 5.1% (a).

**Pending reconsiderations:** USG issued a payment-percentage reconsideration notice in May 2026 while holding at 11% (b); B&W's June 30 cut emerged from a TDP §4.2 reconsideration announced May 7, 2026 (a) — a seven-week notice-to-cut elapsed time that is now the documented template.

**Forward 12–24 month outlook (hedged).** The documented pattern — cuts only, no raises, across 2023–2026 — supports expecting further downward adjustments rather than increases. Specifically: (1) a USG cut is possible within 12–24 months, following the same notice-then-cut sequence B&W just completed (b, pattern inference); (2) the 18 trusts with published percentages show a median of 15.15% (derived from (a)/(b) figures), and the mid-teens cluster still carrying FY2022-era asset data (CE 15.3%, Flintkote 15.0%, Federal-Mogul 12.2%, USG 11.0%, Armstrong 10.8%, Kaiser 10.6%, MLC 10.3% — all (b)) faces renewed downward pressure as FY2025–FY2026 filings land; (3) the sub-8% tier (Celotex 7% (a), Manville 5.1% (a), B&W 4.3% (a)) has limited room left before percentages approach nominal-recovery territory, which historically has triggered deferral periods — Celotex has been in one since January 2025 (a) — rather than further cuts. The high-percentage outliers (NARCO 100%, DII 60%, both (a)) are structurally different stories — funded late and large — and no documented pattern suggests near-term cuts there. These are projections from documented patterns, not certainties; consent processes can and do stall outcomes.

## C. Payouts and depletion: a half-billion-dollar annual outflow, partly offset

Where documents exist, the outflow is substantial and persistent. A documented eight-trust subset — Pittsburgh Corning, W.R. Grace, Manville, GAF, Western, Plant, API, and Combustion Engineering — paid **~$591.9M in claims in 2022 and ~$561.2M in 2024** (a). DII Industries alone reported **$121.1M in claims expense in 2025** (a). Cumulatively, the system's hard documented payout floor is the GAO's **$17.5B paid on 3.3M claims, 1988–2010** (a); the working point estimate for cumulative payouts through today is **~$24B (c)**, an extrapolation from the documented subset and explicitly order-of-magnitude.
...
## D. System events: one closure on the books, three formations in the pipeline, and a governance consolidation

**Formations.** No new §524(g) trust was funded in the window, but the pipeline is the busiest in years. **Georgia-Pacific** abandoned the Bestwall vehicle and is planning a new Chapter 11, with a ~$1B+ trust expected in the next wave (b; size estimate (c)). **DBMP LLC (CertainTeed)** remains in Chapter 11 in the W.D.N.C. — on February 11, 2026 the Fourth Circuit affirmed denial of stay relief in *Herlihy v. DBMP*, leaving roughly 60,000 stayed lawsuits channelled toward an eventual §524(g) trust (a, appellate opinion; claim count (b)). **Trane's** Aldrich Pump and Murray Boiler units have been in Chapter 11 since June 2020 (b) with no trust yet confirmed. None of the three carries a figure in the dataset; none should be counted until funding is documented.

**Closures.** None in the window. The most recent remains **Rapid-American**, which stopped accepting claims, depleted, on June 6, 2025, with final payouts in the ~18–21% range (b). Its record is retained in the dataset as the system's most recent end-of-life data point.
...
|---|---|---|---|
| (a) Filed court document | 9 | $3,965,714,789 | 23.3% |
| (b) Secondary citing primary | 32 | $13,076,231,337 | 76.7% |
| (c) Estimate/inference | 0 | excluded from point sum | — |

**Upgraded this cycle:** nine trusts moved onto filed-document footing — NARCO, DII, Western, Thorpe Insulation, Plant, and J.T. Thorpe (CA) at FY2025; Manville at Q1 2026 (filed April 27, 2026); Maremont and API at FY2024. **Staleness:** 28 of 32 class-(b) figures are dated FY2022 and 4 FY2021 — every one beyond the site's 18-month staleness threshold. **Known gaps:** ~19 of ~60 active trusts publish no retrievable figure; four annual reports are PACER-only (W.R. Grace FY2025, Pittsburgh Corning FY2024, Celotex FY2024, B&W FY2024 — filed but not in the free RECAP archive); the Delticus/Bendix trust publishes no public financials. **Aggregate-level class-(c) figures in use:** the $22.5B high, the ~$24B cumulative-payout point, and the ~$0.5B/yr net-depletion rate.

## F. Watch list — next quarter

1. **USG reconsideration outcome** — a cut within 12–24 months is possible per the documented notice-then-cut pattern (b); an announcement would likely follow B&W's seven-week template.
2. **B&W consent process** — whether TAC/FCR consent ratifies 4.3% or forces adjustment under the "until further notice" letter (a).
3. **Pittsburgh Corning true-up** — adoption or reversion of the 19% reconsidered percentage (a).
4. **Formation pipeline** — a Georgia-Pacific refiling (b; potential ~$1B+ trust, (c)), DBMP plan confirmation post-*Herlihy* (a, docket), any Aldrich/Murray movement (b).
5. **FY2025 annual reports** for the 32 secondary-carried trusts, plus PACER pulls for the four PACER-only filings — the single largest floor-quality upgrade available.
6. **Celotex deferral period** — status of the 7% percentage under the deferral in effect since January 2025 (a).
7. **Cross-Trust Audit and §5.5** — first published audit findings; any spread of verbatim TDP amendments beyond the DCPF trusts (a).
8. **Manville Q2 2026 quarterly filing** — the system's highest-frequency class-(a) data point (Q1 was filed April 27, 2026).
