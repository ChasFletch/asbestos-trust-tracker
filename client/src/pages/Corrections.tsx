      ...
      <div className="space-y-8 text-sm leading-relaxed">
        ...
        <section className="border-t border-border/30 pt-6">
          ...
          <div className="space-y-3 text-xs text-muted-foreground">
            {[
              { date: "2026-09-24", trust: "Leslie Controls, Inc. Asbestos Personal Injury Trust", change: "Net claimants’ equity added as $63,969,328 as of December 31, 2025, replacing an unquantified record. The documented remaining-assets floor increased from $16,033,489,279 across 43 records to $16,097,458,607 across 44 records. This is a filed, mixed-date floor—not a current total for all U.S. trusts.", source: "Leslie Controls FY2025 Special-Purpose Financial Statements, Bankr. D. Del. 10-12199 (CSS) Doc 825 (filed Apr. 20, 2026), Statement of Net Claimants’ Equity p. 4" },
              { date: "2026-08-29", trust: "Owens-Illinois Asbestos Personal Injury Trust", change: "Payment percentage corrected from an erroneous structured 100% value to 65%, effective August 19, 2026. The correction follows a trust-issued notice stating that the Trustees increased the rate from 50% to 65%; claimants previously paid at a lower percentage are eligible for supplemental payments under TDP §4.3.", source: "Owens-Illinois Trust, Notice re: O-I Payment Percentage Increase (Aug. 19, 2026)" },
              { date: "2026-08-29", trust: "Manville Personal Injury Settlement Trust", change: "Net claimants’ equity updated from $539,260,000 to $570,516,505 as of June 30, 2026. The tracker’s cumulative series updated to $5,343,613,806 on 1,041,171 liquidated claims; the source label now makes clear that this is liquidated value rather than a pure cash-paid total.", source: "Manville Q2 2026 Financial Statements, S.D.N.Y. Doc 4480 (filed July 27, 2026)" },
              { date: "2026-08-16", trust: "Site-wide canonical figures", change: "llms.txt, FAQ structured data, and homepage/server fallbacks re-synced to current data: remaining-assets floor $15,987,271,944; cumulative payouts $30,020,097,653 bottom-up; 55 tracked records / 42 with located figures; payment-percentage range 0.7%–100%; largest documented balance W.R. Grace $1,829,172,468 (filed).", source: "trust-figures.json as of 2026-08-16" },
              { date: "2026-08-16", trust: "Hercules Chemical Co. and United Gilsonite (UGL) trusts", change: "Two trusts added from verified research-corpus records: Hercules Chemical ($4,018,899; 2.0% eff. 2022-10-17) and UGL ($16,044,821; 3.35% eff. 2024-04-11), both Verus-administered. Remaining-assets floor $15,967,208,224 → $15,987,271,944.", source: "Research corpus followup_dim08 (FY2022 figures)" },
              { date: "2026-08-16", trust: "Per-claimant statistics", change: "New Methodology section and llms.txt note document that no public per-claimant trust-count or total-recovery statistic exists (RAND TR-872 p. xvii), with the three measured figures (Garlock 22 trusts/~$600K; Ableman 18 filed; ILR 2024 ~13 qualified) presented with provenance and vintage caveats.", source: "Sourcing audit 2026-08-16; Ableman reprint verified verbatim" },
