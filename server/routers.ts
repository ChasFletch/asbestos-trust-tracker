...
function mergeTrust(jsonTrust: any, dbTrust?: any, history?: any[]) {
  ...
  return {
    ...
    paymentPctEffective: (jsonTrust as any).paymentPctEffective ?? dbTrust?.paymentPctEffective ?? null,
    ...
    allTrusts: publicProcedure.query(async () => {
      try {
        ...
        const trusts = (data.trusts ?? []).map((t: any) => ({
          ...
          paymentPctAsOf: (t.paymentPctAsOf ?? null) as string | null,
          paymentPctNoticePublishedAt: (t.paymentPctNoticePublishedAt ?? null) as string | null,
          paymentPctImplementationStatus: (t.paymentPctImplementationStatus ?? null) as string | null,
          paymentPctImplementationNote: (t.paymentPctImplementationNote ?? null) as string | null,
          paymentPercentageSource: (t.paymentPercentageSource ?? null) as string | null,
          paymentPercentageSourceUrl: (t.paymentPercentageSourceUrl ?? null) as string | null,
    ...
    bySlug: publicProcedure
      ...
      .query(async ({ input }) => {
        try {
          ...
          paymentPctAsOf: (trust.paymentPctAsOf ?? null) as string | null,
          paymentPctNoticePublishedAt: (trust.paymentPctNoticePublishedAt ?? null) as string | null,
          paymentPctImplementationStatus: (trust.paymentPctImplementationStatus ?? null) as string | null,
          paymentPctImplementationNote: (trust.paymentPctImplementationNote ?? null) as string | null,
          paymentPercentageFB: (trust.paymentPercentageFB ?? null) as number | null,
          rateSource: (trust.rateSource ?? null) as string | null,
          tdpCaveat: (trust.tdpCaveat ?? null) as string | null,
          direction: (trust.direction ?? null) as string | null,
          company: (trust.company ?? null) as string | null,
          court: (trust.court ?? null) as string | null,
          docket: (trust.docket ?? null) as string | null,
          website: (trust.website ?? null) as string | null,
          administrator: (trust.administrator ?? null) as string | null,
          reportingFrequency: (trust.reportingFrequency ?? null) as string | null,
