...
|---|---|---|---|---|
| 2026-09-24 | Leslie Controls / remaining-assets floor | Leslie assets `null` → **$63,969,328** @2025-12-31; aggregate floor **$16,033,489,279 → $16,097,458,607** across 44 records | Leslie Controls FY2025 Special-Purpose Financial Statements, Bankr. D. Del. 10-12199 (CSS) Doc 825, filed 2026-04-20, Statement of Net Claimants’ Equity p.4 (a); [official trust PDF](https://leslie.mfrclaims.com/assets/documents/resources/LESLIE%20CONTROLS%20TRUST_Annual%20_Report_2025.pdf) | Pending publication checkpoint |
| 2026-09-01 | ABB Lummus / remaining-assets floor | ABB assets `null` → **$14,960,830** @2025-12-31; aggregate floor **$16,018,528,449 → $16,033,489,279** across 43 records | ABB Lummus FY2025 Annual Report, Bankr. D. Del. 06-10401 (MFW) Doc 529, filed 2026-04-28, Exhibit A p.15 (a); [official trust PDF](https://abblummustrust.org/assets/uploadedFiles/04e9a249-cf90-4bfd-a2cb-21a0016473ad.pdf) | `7ff0adb` |
| 2026-08-29 | Manville remaining-assets floor component | **$539,260,000** @2026-03-31 → **$570,516,505** @2026-06-30; aggregate floor **$15,987,271,944 → $16,018,528,449** | Manville Q2 2026 Financial Statements, S.D.N.Y. 82-11656 Doc 4480, filed 2026-07-27, p.6 (a); [retained source PDF](/manus-storage/Manville-Q2-2026-Financial-Statements-Doc4480_0eacb16f.pdf) | Pending publication checkpoint |
| 2026-08-29 | Manville cumulative-series component | **$5,329,722,253** @2026-03-31 → **$5,343,613,806** @2026-06-30; bottom-up payout total **$30,020,097,653 → $30,033,989,206**; filed tier **$17,110,328,204 → $17,124,219,757** | Manville Q2 2026 Financial Statements, Exhibit III, S.D.N.Y. 82-11656 Doc 4480 (a). The series is “Total Trust Liquidated Claims,” not a pure cash-paid total; the filing separately reports unpaid claims. | Pending publication checkpoint |
| 2026-08-29 | Owens-Illinois / Paddock payment percentage | Prior 50% notice and erroneous structured **100%** field → **65%**, effective 2026-08-19 | O-I Trust *Notice re: O-I Payment Percentage Increase* (a): Trustees approved a 50% → 65% increase; supplemental payments apply under TDP §4.3. [Retained source PDF](/manus-storage/OI-Trust-Payment-Percentage-Increase-2026-08-19_418b2c7d.pdf) | Pending publication checkpoint |
| 2026-08-16 | Remaining-assets floor | $15,967,208,224 → **$15,987,271,944** (high $21,721,071,877 → $21,742,138,783) | Added Hercules Chemical **$4,018,899** and United Gilsonite UGL **$16,044,821** — FY2022, Verus-administered (b, research corpus followup_dim08). Dataset now 55 records / 42 with located figures | `81154ec` |
| 2026-08-16 | llms.txt / FAQ / fallbacks re-sync; per-claimant statistics section | payouts → **$30,020,097,653**; floor → **$15,987,271,944**; counts → **55 tracked / 42 with figures**; pct range → **0.7%–100%**; new "Per-Claimant Statistics: A Measured Void" content (RAND TR-872 p. xvii; Garlock 504 B.R. 71, 96; Ableman 30:19 Mealey's, verified) | Display-layer sync + sourcing audit 2026-08-16 | `81154ec` |
| 2026-08-13 | Cumulative payouts headline | $29,981,797,653 → **$30,020,097,653** (filed tier $15,132,028,204/11 → **$17,110,328,204/12**; secondary $11,349,769,449/8 → **$9,409,769,449/7**) | B&W ~**$1.9783B** promoted (b)→(a): FY2023 filed Annual Report and Account, E.D. La. 00-10992 Doc 7876-1 (upstream work) | `41def53` |
| 2026-08-12 | Remaining-assets floor | $16,746,136,347 → **$15,967,208,224** | Merge-patch v2 (18 changes, 6 downgrades, 10 additions); OC/FB, Armstrong, USG payout figures re-tiered (a)→(b) — payouts headline unchanged | `034d529` |
